...
public class BpelEngineImpl implements BpelEngine {
     ...
     */
    private AbstractInstanceLockManager _instanceLockManager = new InstanceLockManager();
    ...
    public void setHazelcastInstance(HazelcastInstance instance) {
        _instanceLockManager = new HazelcastInstanceLockManager(instance);
    }
    ...
    public void acquireInstanceLock(final Long iid) {
        ...
        } catch (AbstractInstanceLockManager.TimeoutException e) {
